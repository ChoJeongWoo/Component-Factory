...
import Sandpack from "@/shared/components/Sandpack";
import Reference from "@/shared/components/Reference";
...
`,
  ...
  return (
    <>
      <div className="relative bg-gradient-to-br from-purple-900 to-indigo-900 w-full rounded flex justify-center items-center py-16 mb-6">
        {/* <Select /> */}
      </div>
